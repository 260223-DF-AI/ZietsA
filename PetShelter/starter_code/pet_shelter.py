...
class Cat(Animal):
    ...
    def describe(self):
        ...
        return f"{base} - {self.color}, {self.is_indoor}"
...
def main():
    ...
    # TODO: Add a Cat
    shelter.add_animal(Cat("Whiskers", 3, "Black"))
    # TODO: Add a Puppy
    shelter.add_animal(Puppy("Cutie", 6, "Yellow Lab"))
    # TODO: Add a ServiceDog
    shelter.add_animal(ServiceDog("Helper", 6, "Yellow Lab", "guide"))
    # TODO: Add a Kitten
    shelter.add_animal(Kitten("Jinkies", 7, "Black"))
